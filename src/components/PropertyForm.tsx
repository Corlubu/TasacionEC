...
interface PropertyFormProps {
  ...
  submitLabel?: string;
  readOnly?: boolean; // 🚨 MAGIA APLICADA: Propiedad para bloquear el formulario
}
...
export function PropertyForm({
  ...
  isSubmitting = false,
  submitLabel = "Guardar",
  readOnly = false, // Lo inicializamos en falso por defecto
}: PropertyFormProps) {
  ...
  const handleFormSubmit = (data: PropertyFormData) => {
    if (readOnly) return; // Por si acaso
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
        ...
        <Tab.Panels className="mt-6">
          ...
          >
            ...
            <Tab.Panel unmount={false} className="space-y-6">
              {/* Ocultamos alertas de actualización futura si estamos en solo lectura */}
              {!readOnly && (
                <div className="mb-6 rounded-lg border border-yellow-200 bg-yellow-50 p-4">
                  <p className="text-sm text-yellow-800">
                    <strong>Próxima actualización:</strong> Los campos de
                    latitud y longitud serán reemplazados por un mapa
                    interactivo donde podrá arrastrar un pin para fijar la
                ...
                <div className="grid grid-cols-2 gap-3 md:grid-cols-5">
                  {propertyTypes.map((type) => (
                    <label
                      ...
                      } ${readOnly && propertyType !== type.value ? "cursor-not-allowed opacity-50" : ""}`}
                    >
                      <input
                        type="radio"
                        value={type.value}
                  ...
                  {propertyType === "APARTMENT" && (
                    <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 md:col-span-2">
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-blue-300 px-4 py-3 focus:border-transparent focus:ring-2 focus:ring-blue-500 disabled:bg-blue-100"
                        placeholder="15.50"
                      />
                      <p className="mt-1 text-xs text-blue-700">
                        <strong>Normativa SBS 2.3:</strong> Para apartamentos,
                        se debe especificar el porcentaje de participación en
                        áreas comunales. Este valor se aplicará al cálculo de
                        áreas comunales en el costo de construcción.
                      </p>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div>
                        ...
                        >
                          ...
                          <option value="TEMPERED_GLASS">
                            Vidrio Templado
                          </option>
                          <option value="LAMINATED_GLASS">
                            Vidrio Laminado
                          </option>
              ...
              {propertyType !== "LAND" && (
                <>
                  ...
                  <div>
                    ...
                    <p className="mb-4 text-sm text-gray-600">
                      Campos opcionales para compatibilidad con sistemas
                      antiguos
                    </p>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                      <div>
      ...
      {/* Submit Button Area - Totalmente dinámico dependiendo de readOnly */}
